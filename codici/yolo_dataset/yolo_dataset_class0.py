...
#  CLASSE 0 CONTIENE 3 OGGETTI DI TIPO QCD

# lettura del file CSV
csv_path= '/gwpool/users/bscotti/tesi/dati/dati_jet/immagini_finali_spero/fixed_patch/final_0_noP_noBkg_025/bbox_0_noP_noBkg_025.csv'
annotations_df = pd.read_csv(csv_path)
annotations_df['image_name'] = annotations_df['image_name'].str.replace('.npy', '.png') 
annotations_df["image_path"] = "/gwpool/users/bscotti/tesi/dati/dati_jet/immagini_finali_spero/fixed_patch/final_0_noP_noBkg_025_png/" + annotations_df["image_name"]
...
yolo_annotations_df = pd.DataFrame({
    ...
    'class_id1': 0,
    'x_center1': (annotations_df['qcd1_xmin']+ annotations_df['qcd1_width']/2) / img_size[0],
    'y_center1': (annotations_df['qcd1_ymin'] + annotations_df['qcd1_height']/2) / img_size[1],
    'width1': annotations_df['qcd1_width'] / img_size[0],
    'height1': annotations_df['qcd1_height'] / img_size[1],
    ...
    'class_id3': 0,
    'x_center3': (annotations_df['qcd3_xmin']+ annotations_df['qcd3_width']/2) / img_size[0],
    'y_center3': (annotations_df['qcd3_ymin'] + annotations_df['qcd3_height']/2) / img_size[1],
    'width3': annotations_df['qcd3_width'] / img_size[0],
    'height3': annotations_df['qcd3_height'] / img_size[1]
})
